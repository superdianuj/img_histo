...
def histogram_1d(img):
    ...
    plt.xlabel("Color Value", fontsize=20)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dir', help='image directory path')
    parser.add_argument('--choice', help='1d, 2d, 3d', default='1d')
    ...
    for img_pth in img_paths:
        ...
        img_collective.append(img)
    
    img_collective=np.concatenate(img_collective,0)
    	
    main(img_collective,args.choice)
